...
import dev.yaks.maven.extension.configuration.json.JsonFileDependencyLoader;
import dev.yaks.maven.extension.configuration.properties.PropertyFileDependencyLoader;
import dev.yaks.maven.extension.configuration.yaml.YamlFileDependencyLoader;
