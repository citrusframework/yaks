...
|0.13.0-SNAPSHOT	|link:/yaks/reference/0.13.0-SNAPSHOT/html/index.html[HTML] |link:/yaks/reference/0.13.0-SNAPSHOT/pdf/yaks-reference-0.13.0-SNAPSHOT.pdf[PDF]
