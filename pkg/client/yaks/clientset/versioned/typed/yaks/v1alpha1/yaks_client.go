...
import (
	...
	"github.com/citrusframework/yaks/pkg/client/yaks/clientset/versioned/scheme"
...
// NewForConfig creates a new YaksV1alpha1Client for the given config.
...
// NewForConfigAndClient creates a new YaksV1alpha1Client for the given config and http client.
...
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*YaksV1alpha1Client, error) {
	...
	return &YaksV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new YaksV1alpha1Client for the given config and
...
func New(c rest.Interface) *YaksV1alpha1Client {
	return &YaksV1alpha1Client{c}
}
