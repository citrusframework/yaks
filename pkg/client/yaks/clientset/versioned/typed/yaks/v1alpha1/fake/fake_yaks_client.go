...
import (
	v1alpha1 "github.com/citrusframework/yaks/pkg/client/yaks/clientset/versioned/typed/yaks/v1alpha1"
	rest "k8s.io/client-go/rest"
	testing "k8s.io/client-go/testing"
)

type FakeYaksV1alpha1 struct {
	*testing.Fake
}
...
func (c *FakeYaksV1alpha1) RESTClient() rest.Interface {
