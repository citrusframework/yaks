...
type FakeInstances struct {
	Fake *FakeYaksV1alpha1
	ns   string
}

var instancesResource = schema.GroupVersionResource{Group: "yaks.citrusframework.org", Version: "v1alpha1", Resource: "instances"}

var instancesKind = schema.GroupVersionKind{Group: "yaks.citrusframework.org", Version: "v1alpha1", Kind: "Instance"}
