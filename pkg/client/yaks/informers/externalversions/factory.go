...
import (
	...
	yaks "github.com/citrusframework/yaks/pkg/client/yaks/informers/externalversions/yaks"
...
func (f *sharedInformerFactory) Yaks() yaks.Interface {
	return yaks.New(f, f.namespace, f.tweakListOptions)
}
